...
- An additional 10 μF stability/noise filtering capacitor is placed between the transceiver power rails just to be sure (not required with the regulator module)
